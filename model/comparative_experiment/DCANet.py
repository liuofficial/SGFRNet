...
class DCANet(nn.Module):
    def __init__(self, num_classes=1, input_channels=3, block=Res_SimAM_block, num_blocks=[3, 4, 6, 3], nb_filter=[16,32, 64, 128, 256], deep_supervision=True,mode="test"):
